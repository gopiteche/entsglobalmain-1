				...
				<!-- Form Element sizes -->
				  <div class="box box-success">
					<div class="box-header with-border">
					  <h2 class="box-title">Add Career</h2>
					</div>
                    ...
                    <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
							  <input onclick="this.showPicker()" type="date" name="date" value="" class="form-control" required/>
							</div>
                          </div>  
                          ...
                          <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
	    					 <input class="form-control" name="tittle"  placeholder="Title" type="text" required>	
							</div>
                          </div>
						  ...
						  <div class="col-xs-12 col-sm-3 row-seperate">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
	    <input class="form-control" name="type"  placeholder="Part Time/Full Time" type="text" required>	
							</div>
                          </div>
						  ...
						  <div class="col-xs-12 col-sm-3 row-seperate">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
	    <input class="form-control" name="exp"  placeholder="Experience Required" type="text" required>	
							</div>
              </div>
						  ...
						  <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
	    	<input class="form-control" name="location"  placeholder="Location" type="text" required>	
							</div>
                          </div>
                    ...
                    <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
							  <textarea class="form-control" name="desc_i"  id="editor1" rows="5" cols="40"  type="text"></textarea>	
							</div>
                          </div>   
						  ...
						  <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
								...
								<textarea id="editor1" name="duties"></textarea>
						  ...
						  <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
								...
								<textarea id="editor4" name="require"></textarea>
						  ...
						  <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
								...
								<textarea class="editor" name="skills"></textarea>
