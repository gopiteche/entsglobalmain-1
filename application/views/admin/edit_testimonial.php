				                  ...
				                  <!-- Form Element sizes -->
				                    <div class="box box-success">
					                    <div class="box-header with-border">
					                        <h2 class="box-title">Edit Testimonial</h2>
					                    </div>
					                    <div class="box-body">
                         ...
                         <?php $parent = $this->uri->segment(4); ?>
											...
											<div class="row">
												...
												<div class="col-xs-12 col-sm-9 row-seperate">
													<input class="form-control" name="name"  placeholder="Name" type="text" value="<?php echo $testimonial['testimonial_name']; ?>" required>	
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-xs-12 col-sm-9 row-seperate">
													<input class="form-control" name="place"  placeholder="Place" type="text" value="<?php echo $testimonial['testimonial_place']; ?>" required>	
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-xs-12 col-sm-9 row-seperate">
													<textarea class="form-control" name="desc_i"  id="editor1" rows="5" cols="40"><?php echo $testimonial['testimonial_desc']; ?></textarea>	
												</div>
											</div>    
                          ...
                          <?php if(!empty($testimonial['testimonial_img'])){?>
											<div class="row">
												<div class="col-xs-12 col-sm-3 row-seperate">
													<label>Default Image(size:100*100)<strong style="color:#F00;">*</strong></label>
												</div>
												<div class="col-xs-12 col-sm-9 row-seperate">
													<a href="<?php echo base_url();?>uploads/testimonial/<?php echo $testimonial['testimonial_img']; ?>" class="fancybox-media">
														<img src="<?php echo base_url(); ?>uploads/testimonial/<?php echo $testimonial['testimonial_img']; ?>" width="150px" height="150px"/>
													</a>   
												</div>
											</div> 
