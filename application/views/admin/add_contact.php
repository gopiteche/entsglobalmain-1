				              ...
				              <!-- Form Element sizes -->
				                <div class="box box-success">
									<div class="box-header with-border">
									    <h2 class="box-title">Add Contact Details</h2>
									</div>
									<div class="box-body">
										...
										<div class="row">
										    ...
										    <div class="col-xs-12 col-sm-9 row-seperate">
												 <input class="form-control" name="location"  id="cat_name"   required>	
											</div>
									    </div>
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-9 row-seperate">
											    <textarea class="form-control" name="address"  id="cat_name" row="6" type="text" value="" required></textarea>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-9 row-seperate">
											    <input class="form-control" name="email"  id="cat_name" type="email" required>	
											</div>
										</div>
