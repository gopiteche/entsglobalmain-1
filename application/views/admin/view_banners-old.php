                  			...
                  			<table id="datatable" class="table table-bordered table-striped delTable">
						        ...
						        <td><?php echo $val->ban_sub_heading; ?></td>
									    ...
									    <td>
											...
											<a style="color:rgb(102, 102, 102);" href="<?php echo base_url(); ?>admin/Banner/EditBanner/<?php echo $val->ban_id;?>" class="edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i style="color:rgb(255, 204, 102);" class="fa fa-pencil-square-o"></i>  Edit</a><br>
