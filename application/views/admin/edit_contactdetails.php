									...
									<div class="box-body">
										...
										<div class="row">
										    ...
										    <div class="col-xs-12 col-sm-9 row-seperate">
												 <input class="form-control" name="location"  id="cat_name"  value="<?php echo $contact_data['location']; ?>" required>	
											</div>
									    </div>
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-9 row-seperate">
											    <textarea class="form-control" name="address"  id="cat_name" row="6" type="text" value="" required><?php echo $contact_data['address']; ?></textarea>
											</div>
										</div>
										...
										<div class="row">
										    ...
										    <div class="col-xs-12 col-sm-9 row-seperate">
												 <input class="form-control" name="phone"  id="cat_name"  value="<?php echo $contact_data['phone']; ?>" required>	
											</div>
									    </div>
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-9 row-seperate">
											    <input class="form-control" name="email"  id="cat_name" type="email" value="<?php echo $contact_data['email']; ?>" required>	
											</div>
										</div>
