                                ...
                                <tbody>
									...
									foreach($cms_data as $item=>$val):?>
                       				    ...
                       				    <tr id="<?php echo $val->content_id;?>">
											...
											<td><?php echo general_text(strip_tags($about_description),25); ?></td>
										  
										    <td>
					                            <a style="color:rgb(102, 102, 102);" href="<?php echo base_url(); ?>admin/CMS/EditCMS/<?php echo $val->content_id;?>" class="edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i style="color:rgb(255, 204, 102);" class="fa fa-pencil-square-o"></i>  Edit</a>
											</td>
