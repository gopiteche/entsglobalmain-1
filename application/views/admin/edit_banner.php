                            ...
                            <div class="box-body">
				                ...
				                <div class="box box-success">
					                ...
					                <div class="box-body">
										...
										<div class="row">
											<div class="col-xs-12 col-sm-3 row-seperate">
											    <label>Read More Link (Provide Url After Domain Name)<strong style="color:#F00;">*</strong></label>
											</div>
											<div class="col-xs-12 col-sm-9 row-seperate">
					      <input class="form-control" name="ban_txt"  placeholder="" type="text" value="<?php echo $banner_data['ban_link']; ?>" required>	
											</div>
										</div>
